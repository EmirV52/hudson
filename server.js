...
// godnext botun server.js ayarları 
// kendinize göre ayarlayınız ! 

// PROJE
var express = require('express');
var app = express();
// Size Express ile başladık, 
// ancak "package.json" aracılığıyla istediğiniz kitaplıkları veya çerçeveleri kullanmaktan çekinmeyin.

// http://expressjs.com/en/starter/static-files.html Buraya bir bak derim kanki :)
...
var listener = app.listen(process.env.PORT, function() {
  console.log('godnext Bot Başlatılıyor. Port: ' + listener.address().port);
});
...
client.ayarlar = {
  "token": "TOKEN GİR", //Buraya botunuzun https://discordapp.com/developers/applications sitesindeki tokenini yazıyoruz kankii
  "sahip": "476397948549201931",//Buraya bot sahibinin IDini giriniz
  ...
  "prefix": "m!", //Burada "!" i botunuzun prefixi ile değiştiriniz (Prefix: Komutları kullanırken başa koyulan "!, *, ., b!" vb.)
  "versiyon": "1.0.0", //Buraya botunuzun versiyonunu yazınız
};

client.on("ready", async () => {
  console.log(`Developer By godnext!`)
  client.user.setActivity(`godnext İyi Roller Diler`)
...
client.login(client.ayarlar.token); // Giriş yapılıyor kanki buraya 
...
// BU PAKET MG DEVELOPMENTS AİTTİR ! GELİŞTİRİLMİŞTİR - EDİTLENMİŞTİR godnext#0808 
// BU PAKET MG DEVELOPMENTS AİTTİR ! GELİŞTİRİLMİŞTİR - EDİTLENMİŞTİR godnext#0808 
// BU PAKET MG DEVELOPMENTS AİTTİR ! GELİŞTİRİLMİŞTİR - EDİTLENMİŞTİR godnext#0808 
// BU PAKET MG DEVELOPMENTS AİTTİR ! GELİŞTİRİLMİŞTİR - EDİTLENMİŞTİR godnext#0808 
// BU PAKET MG DEVELOPMENTS AİTTİR ! GELİŞTİRİLMİŞTİR - EDİTLENMİŞTİR godnext#0808 
